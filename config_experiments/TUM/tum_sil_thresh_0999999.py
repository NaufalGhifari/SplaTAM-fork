...
group_name = "TUM"
run_name = f"{scene_name}_seed{seed}_sil-thresh-0999999"
...
config = dict(
    ...
    use_wandb=True,
    wandb=dict(
        entity="naufal-ghifari-universitas-indonesia",
        project="SplaTAM-fork",
        group=group_name,
        name=run_name,
        save_qual=False,
        eval_save_qual=True,
    ...
    tracking=dict(
        ...
        sil_thres=0.0999999,                ## EXP: Silhouette Loss Threshold = 0.0999999
        use_l1=True,
