...
map_every = 4               # default: 1
keyframe_every = 10         # defalut: 5
mapping_window_size = 24
tracking_iters = 30         # default: 40
mapping_iters = 50          # default: 60

group_name = "Replica"
run_name = f"{scene_name}_Sil-Thresh-999999_{seed}"
...
config = dict(
    ...
    data=dict(
        ...
        sequence=scene_name,
        desired_image_height=340, # halved from 680
        desired_image_width=600,  # halved from 1200
        start=0,
        end=-1,            # defalut: -1
        stride=1,
    ...
    tracking=dict(
        ...
        sil_thres=0.999999,              # EXP: Silhouette threhsol set to 0.5 instead of 0.99
        use_l1=True,
